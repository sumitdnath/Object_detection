...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '/home/wangshiyao/Documents/data/imagenet/', 'Root directory to raw VID dataset.')
flags.DEFINE_string('set', 'train', 'Convert training set, validation set or '
                    'merged set.')
flags.DEFINE_string('annotations_dir', 'Annotations',
                    '(Relative) path to annotations directory.')
flags.DEFINE_string('output_path', '/data2/imagenet/VID/TF/train_tf', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', '/home/wangshiyao/Documents/data/imagenet/gen_list/vid_local_map.pbtxt',
...
def dict_to_tf_example(data,
  ...
  if 'VID' in data['folder']:
      full_path = os.path.join('/home/wangshiyao/Documents/data/imagenet/VID/ILSVRC/Data/VID/train', img_path+'.JPEG')
  else:
      full_path = os.path.join('/home/wangshiyao/Documents/data/imagenet/DET/ILSVRC2015/Data/DET/train', example.replace('.xml','.JPEG').replace('Annotations','Data'))
